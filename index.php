...
//use App\controller\ProdutoController;
    ...
    $rota = explode("/",$rota);// explode irá criar um vetor separando as informaçoes quando encontrar uma /
    ...
    if($rota[0] === "api"){
        ...
        if(!file_exists("App\controller\\".$rota[0]."Controller.php")){
            ...
            $servico = "App\controller\\".ucfirst($rota[0])."Controller";// Organizando o aminho para deixar com o mesmo nome da classe da pasta controller
        echo"<hr> {$servico}";
        ...
        "Tá querendo acessar outra coisa né?";
    }